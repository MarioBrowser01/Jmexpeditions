                    ...
                    <div class="card-body">
                        <form action="../../app/controller/paquetes/update.php" method="post">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="tipo_paquete" name="tipo_paquete" required onchange="ajustarDuracion()">
                                            ...
                                            <option value="VariosDías" <?php echo $paquete['tipo_paquete'] == 'VariosDías' ? 'selected' : ''; ?>>Varios Días</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="card-action">
                                ...
                                <button onclick="cancelarActualizar('Paquete')" data-entity="Paquete" class="btn btn-danger">Salir</button>
                            </div>
                        </form>
                    </div>
                </div>
