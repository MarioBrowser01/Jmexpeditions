...
$basePath = 'app/Http/Controllers/dashboard/';

include dirname(__DIR__) . '/layouts/header.php';
include $basePath . 'categorias/listar-categoria.php';
include $basePath . 'categorias/create.php';
include $basePath . 'categorias/update.php';
include $basePath . 'categorias/delete.php';
        ...
        <div class="col m-0" id="form_registrar">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <form action="../../app/Http/Controllers/dashboard/categorias/create.php" method="post" enctype="multipart/form-data">
        ...
        <div class="col m-0" id="form_actualizar" style="display:none;">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <form action="<?php echo $URL; ?>app/Http/Controllers/dashboard/categorias/update.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <td>
                                                <center>
                                                    <div class='col-sm-3 col-sm-12 d-flex flex-wrap gap-1'>
                                                        ...
                                                        <a href='../../app/Http/Controllers/dashboard/categorias/delete.php?id=<?php echo $id_categoria; ?>' class='btn col btn-danger btn_eliminar' data-entity="Categoria"><i class='fa fa-trash'></i></a>
