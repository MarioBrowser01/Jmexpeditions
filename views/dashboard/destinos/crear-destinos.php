                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div id="nombreGroup" class="form-group">
                      <label for="nombre">Nombre del Destino</label>
                      <input type="text" name="nombre" id="nombre" onkeyup="verificarNombreEntidad('destinos', 'nombreGroup')" class="form-control" required>
                      <span class="help-block" style="display:none;">Este nombre de destino ya existe</span>
                    </div>
