          ...
          <ul class="nav nav-secondary">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="paquetes">
                <ul class="nav nav-collapse">
                  <li>
                    <a href="<?php echo $URL; ?>pages/paquetes/crear-paquete.php">
                      <span class="sub-item">Registrar paquetes</span>
                    </a>
                  </li>
                  <li>
                    <a href="<?php echo $URL; ?>pages/paquetes/index.php">
                      <span class="sub-item">Listado</span>
                    </a>
                  </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="Itinerarios">
                <ul class="nav nav-collapse">
                  <li>
                    <a href="<?php echo $URL; ?>pages/itinerarios/index.php">
                      <span class="sub-item">Lista de itinerarios</span>
                    </a>
                  </li>
                  <li>
                    <a href="<?php echo $URL; ?>pages/itinerarios/crear-itinerario.php">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="tables">
                <ul class="nav nav-collapse">
                  <li>
                    <a href="<?php echo $URL; ?>pages/galerias/subir-imagen.php">
                      <span class="sub-item">Subir Imagenes</span>
                    </a>
                  </li>
                  <li>
                    <a href="<?php echo $URL; ?>pages/galerias/index.php">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="videos">
                <ul class="nav nav-collapse">
                  <li>
                    <a href="<?php echo $URL; ?>pages/videos/subir-video.php">
                      <span class="sub-item">Subir Videos</span>
                    </a>
                  </li>
                  <li>
                    <a href="<?php echo $URL; ?>pages/videos/index.php">
