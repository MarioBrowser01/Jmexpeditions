<?php
// include_once 'app/config.php'; // Ajusta la ruta según la ubicación de tu archivo
...
<head>
	...
	<!-- Para seccion testimonios -->
	<link rel="stylesheet" href="https://unpkg.com/swiper/swiper-bundle.min.css" />

	<title>JM Expeditions</title> <!-- Título dinámico -->

	<link rel="stylesheet" href="<?php echo $URL; ?>css/landing/app.css">
	<!-- <link rel="stylesheet" href="<?php echo $URL; ?>js/landing/landing.min.js"> -->
	...
	<nav id="mainNavbar" class="navbar navbar-expand-lg navbar-dark navbar-custom sticky-top">
		<div class="container">
			<a class="navbar-brand animate__fadeInDown" href="<?php echo $URL; ?>index.php">
				<img src="<?php echo $URL; ?>images/web/Horizontal_jm.png" alt="JM Expeditions" style="max-height: 50px;">
			</a>
